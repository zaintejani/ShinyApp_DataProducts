...
```{r echo=FALSE}
library(ggplot2); library(datasets); data(mtcars)

qplot(mpg, qsec, data=mtcars, main="Speed Demons", xlab="Fuel Economy", ylab="Quarter mile time")+geom_text(label=rownames(mtcars), color=1+mtcars$am)+geom_smooth(method="lm")
